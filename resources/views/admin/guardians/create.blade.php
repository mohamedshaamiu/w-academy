<x-app-layout portal="admin" :title="__('admin.guardian.create.title')" :header="__('admin.guardian.create.title')">
    <form method="POST" action="{{ route('admin.guardians.store') }}" class="max-w-2xl space-y-4 rounded-xl border border-navy-100 bg-white p-6">
        @csrf
        ...
        <div>
            ...
            <x-text-input id="occupation" name="occupation" class="mt-1 block w-full" :value="old('occupation')" />
